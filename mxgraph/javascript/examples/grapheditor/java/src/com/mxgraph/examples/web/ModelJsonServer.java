...
public class ModelJsonServer implements Runnable {
    ...
    public static boolean emptyQueueForTesting; 

	public ModelJsonServer(int PORT) {
		this.emptyQueueForTesting = false;
		this.counter = 0;
		this.run  = true;
		this.PORT = PORT;
	...
	//==================================================================
		...
		public static void openFileStream() {
			try {
	    		outputFileName = "./javascript/examples/grapheditor/www/resources/registration.json";
