...
Format.prototype.refresh = function()
{
	...
	{
	    mxUtils.write(label, mxResources.get('regressionTesting'));
...
DiagramFormatPanel.prototype.init = function()
{
	...
	//this.container.appendChild(this.addView(this.createPanel())); //disabled by majid

	if (graph.isEnabled())
	{
		//this.container.appendChild(this.addOptions(this.createPanel())); //disabled by majid
		//this.container.appendChild(this.addPaperSize(this.createPanel())); //disabled by majid
		//this.container.appendChild(this.addStyleOps(this.createPanel())); //disabled by majid
